                ...
                <table class="table">
                    ...
                    <tbody>
                        @foreach ($posts as $post)
                            <tr>
                                <td><img src="{{asset('assets/images/' . $post->image)}}" width="100" alt="{{ $post->title }}"></td>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('posts.destroy', $post->id) }}" id="delete-{{$post->id}}" method="post" style="display: none">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </td>
